shared_examples_for "a pageable class" do
  it { subject.class.included_modules.should include(ConstantContact::Pageable) }
  ...
  it ".find_all_deletions_across_pages" do
    class TestClass2 < ConstantContact::Base; include ConstantContact::Pageable; end
